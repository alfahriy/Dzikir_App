...
object DataDzikirDoa {
    ...
    val listQauliyahShalat: ArrayList<DzikirDoa>
        get() {  // Untuk mengatur list qauliyah untuk mendapatkan dari data dari DataDzikirDoa

            val list = arrayListOf<DzikirDoa>()

            for (data in terjemahQauliyah.indices) { // .indices itu akan membaca index number dari sebuah array dan data tersebut akan in range dari array terjemahQauliyah
...
/*
*  Kelemahan data dummy adalah dia harus disesukain jumlah datany
* */